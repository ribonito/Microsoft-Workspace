...
PROCESS
{
	...
	else
	{
	 ...
	 <# Edit line 437 to modify the default command run when this script is executed.
	   ...
	   #>
		Set-UserRights -AddRight -UserRight SeInteractiveLogonRight -Username S-1-5-32-544,S-1-5-32-545
        Set-UserRights -AddRight -UserRight SeCreateGlobalPrivilege,SeImpersonatePrivilege -Username S-1-5-19,S-1-5-20,S-1-5-6,S-1-5-32-544
		Set-UserRights -AddRight -UserRight SeNetworkLogonRight -Username S-1-5-32-544,S-1-5-32-555
		Set-UserRights -AddRight -UserRight SeDenyNetworkLogonRight,SeDenyRemoteInteractiveLogonRight -Username S-1-5-113
		Set-UserRights -AddRight -UserRight SeBackupPrivilege,SeCreatePagefilePrivilege,SeDebugPrivilege,SeLoadDriverPrivilege,SeSecurityPrivilege,SeManageVolumePrivilege,SeSystemEnvironmentPrivilege,SeProfileSingleProcessPrivilege,SeRemoteShutdownPrivilege,SeRestorePrivilege,SeTakeOwnershipPrivilege -Username S-1-5-32-544
	}
}
END
{
