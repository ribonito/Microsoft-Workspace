function Get-MgGraphAllPages {
    <#
    .SYNOPSIS
    Helper funtion to get all pages when using Invoke-MgGraphRequest function
     
    .DESCRIPTION
    Helper funtion to get all pages when using Invoke-MgGraphRequest function. The funtion extracts the value.
    ...
    .EXAMPLE
    Invoke-MgGraphRequest -Uri $Uri | Get-MgGraphAllPages
    #>
