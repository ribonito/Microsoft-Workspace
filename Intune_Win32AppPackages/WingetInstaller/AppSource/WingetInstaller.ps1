...
if($Action -eq "install"){
    ...
    $Arguments = "install --id $id --silent --accept-source-agreements --accept-package-agreements --log ""$env:ProgramData\Microsoft\IntuneManagementExtension\Logs\$Name-winget.log"""
} else {
