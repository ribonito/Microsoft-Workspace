...
<#
.SYNOPSIS
    MIG-001 | Migration - BitTitan/MigrationWiz Statistics and Error Reporting.
...
.AUTHOR
    Pablo Galan Sabugo - BitTitan Technical Sales Specialist Team
    Josep Canas - M365 Solutions Architect (MIG-001 classification & template)
...
.PARAMETER BitTitanProjectType
    This parameter defines the BitTitan project type ('Mailbox','Archive','Storage','PublicFolder','Teamwork').

.PARAMETER ProjectSearchTerm
    This parameter defines which projects you want to process, based on the project name search term.
...
.EXAMPLE
    .\MIG-001_BitTitan-Statistics.ps1

.NOTES
    - Requires BitTitan PowerShell SDK.
#>
