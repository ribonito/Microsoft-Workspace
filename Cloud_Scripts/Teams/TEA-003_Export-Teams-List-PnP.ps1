<#
.SYNOPSIS
    TEA-003 | Microsoft Teams - Export Teams List using PnP PowerShell.

.DESCRIPTION
    Uses PnP PowerShell to connect to Microsoft Graph and retrieve all Microsoft 365 Groups
    that are configured as Microsoft Teams (i.e. have channels). It collects their metadata,
    including channel counts, channel names, and team owners, and exports the data to a CSV.
...
.PRODUCT
    Microsoft Teams / PnP PowerShell / Microsoft Graph
...
.PARAMETER ExportPath
    Path to the output CSV file. Default: C:\Temp\TeamsList.csv

.EXAMPLE
    .\TEA-003_Export-Teams-List-PnP.ps1

.NOTES
    - Requires the PnP.PowerShell module.
    - Connects to Microsoft Graph interactively using Connect-PnPMicrosoftGraph.
#>
