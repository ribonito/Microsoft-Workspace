<#
.SYNOPSIS
    M365-010 | M365 - Run All Assessment Tasks and Export Governance/Compliance Reports.

.DESCRIPTION
    Connects to Microsoft Graph and Exchange Online, then generates a series of
    governance and compliance reports as CSV files:
        - Incident Response Plan (IncidentResponsePlan.csv)
        - Governance Plan (GovernancePlan.csv)
        - Data Management Policies (DataManagementPolicies.csv)
        - Access Control Roles (AccessControlRoles.csv)
        - Compliance Status (ComplianceStatus.csv)
        - Training and Awareness Sessions (TrainingSessions.csv)
        - Governance Framework Components (GovernanceFramework.csv)
        - Audit and Review Logs (AuditLogs.csv)

    Authentication options:
        - Interactive or MFA authentication (delegated) for Microsoft Graph and Exchange Online.

.PRODUCT
    Microsoft 365 / Governance & Compliance / Assessment
...
.NOTES
    ...
    - SharePoint Online connection is disabled by default.
    - Exports are saved in the current working directory.

.EXAMPLE
    .\M365-010_M365-Assessment-All.ps1
#>
