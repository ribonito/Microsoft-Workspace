<#
.SYNOPSIS
    M365-014 | M365 Assessment - SharePoint Online Site Usage Report via Microsoft Graph (App Auth).
...
.MAINTAINER
    Josep Canas - M365 Solutions Architect (M365-014 classification & English header)
...
.EXAMPLE
    .\M365-014_SPO-SiteUsage-GraphReport.ps1
