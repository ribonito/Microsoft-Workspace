<#
.SYNOPSIS
    M365-012 | M365 Assessment - Export M365 Licensing SKUs and Service Plans to CSV via Microsoft Graph.
...
.MAINTAINER
    Josep Canas - M365 Solutions Architect (M365-012 classification & English header)
...
.EXAMPLE
    .\M365-012_M365-Licensing-SKU-Export.ps1
#>
