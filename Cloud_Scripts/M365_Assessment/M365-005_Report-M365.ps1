<#
.SYNOPSIS
    M365-005 | M365 Assessment - Interactive Tenant Report Generator (HTML).

.DESCRIPTION
    Generates a comprehensive and interactive HTML report of your Microsoft 365 tenant.
    Includes details on Users, Tenant Information, Groups, Policies, Contacts, Mail Users,
    Licenses, and more.
...
.AUTHOR
    ...
    Josep Canas - M365 Solutions Architect (M365-005 classification & template)

.VERSION
    1.3

.EXAMPLE
    .\M365-005_Report-M365.ps1

.NOTES
    - Requires AzureAD and ReportHTML modules.
    - Reference: https://www.thelazyadministrator.com/2018/06/21/create-an-interactive-html-report-for-office-365-with-powershell/
#>

#region ── Parameters & Variables ───────────────────────────────────────────
#Company logo that will be displayed on the left, can be URL or UNC
$CompanyLogo = "https://www.thelazyadministrator.com/wp-content/uploads/2018/06/logo-2-e1529684959389.png"

#Logo that will be on the right side, UNC or URL
$RightLogo = "https://www.thelazyadministrator.com/wp-content/uploads/2018/06/amd.png"
